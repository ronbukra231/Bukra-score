        ...
        >
          ...
          <button
            ...
            onClick={async () => {
              ...
              if (err) {
                setError('שגיאה בכניסה עם Google — אנא נסה שוב')
                setGoogleLoading(false)
              }
            }}
            className="w-full flex items-center justify-center gap-3 bg-gray-800 border border-gray-700 text-gray-300 hover:bg-gray-700 hover:text-white font-medium py-2.5 rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {googleLoading ? (
              <span className="text-sm">מתחבר עם Google...</span>
            ) : (
              <>
